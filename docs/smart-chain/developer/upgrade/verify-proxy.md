...
*Please learn how to deploy an upgradable SRC20 contract [here](./proxy.md)*
...
```
$ truffle-flattener SRC20TokenImplementation.sol > SRC20TokenImplementationFlattened.sol
...
- Create new contract `SRC20Token.sol` and copy contract code from flattened `SRC20TokenImplementationFlattened.sol`
- Compile the implementation contract
- Click on this button to switch to the compile page
  - Select “SRC20TokenImplementation” contract
...
- Create new contract proxy.sol and copy contract code from flattened `SRC20UpgradeableProxyFlattened.sol `.  Here is and [example](https://scolcoin.com/address/0xA6Ec2Fe4F6040b188A926048f44c9A59Fca189d4#code)
- Compile the proxy contractClick on this button to switch to the compile page
  - Select “SRC20UpgradeableProxy” contract
  - Enable “Auto compile” and “optimization”Click “ABI” to copy the contract abi and save it.

### Deploy the proxy contract

- Select “Injected Web3”Select “SRC20UpgradeableProxy.sol” contract
...
**Logic**: The address of `SRC20Implementation` contract
**Admin**: admin cannot be SRC20 token owner
...
Note: The way to verify the SRC20TokenImplementation contract is the same as before.
...
First, you need to copy ABI json of “SRC20UpgradeableProxy.sol” contractThen, click on “Parse”
