...
You can write your own smart contract or download the SRC20 token smart contract template.
...
Contract will be deployed on ScolCoin Chain Chapel Testnet, it look like this:
...
**Congratulations!** You have successfully deployed SRC20 Smart Contract. Now you can interact with the Smart Contract.

You can check the deployment status here: <https://scolcoin.com/> or <https://testnet-explorer.scolcoin.com/>
