# Use ScolCoin Chain Extension Wallet
## What is it?
ScolCoin Chain Extension Wallet is a Crypto Wallet for ScolCoin Chain, ScolCoin Chain. You can send and receive funds on ScolCoin Chain, ScolCoin Chain and cross-chain transfers between both of SCOL’s blockchains.

In the future, ScolCoin Chain Extension Wallet will add support for Ethereum blockchain and enable access for distributed applications, or "Dapps" in your browser!
...
[How to manually install the ScolCoin Chain Extension Wallet](manual.md)


## Install

**Example: Install ScolCoin Chain Wallet in Firefox browser**

* Open Extension in Firefox: <https://addons.mozilla.org/en-US/firefox/addon/shree-chain/?src=search>

* Search for ScolCoin Chain
...
Note: Make sure it’s offered by ScolCoin Chain
...
That’s it! You have successfully installed the ScolCoin Chain Wallet extension in Firefox!


The workflow is the same for all browsers
## Create an account in extension wallet for ScolCoin Chain
...
* Install ScolCoin Chain extension by following the previous steps
...
## Get Testnet SCOL from Faucet

* Go to <https://testnet-explorer.scolcoin.com/faucet-smart/>
...
* Switch to ScolCoin Chain Testnet after unlock your extension wallet
...
* Paste your address in the box and click on “Give me SCOL”
* Click on the “+” and add “SCOL” token
...
## Transfer Testnet SCOL from SCOL to BC
* Switch to ScolCoin Chain testnet and copy your address after unlock your extension wallet, start with `tscol1`
...
* Switch to ScolCoin Chain testnet and click on “Send”
...
* Switch back to ScolCoin Chain Testnet to confirm this cross-chain transfer
...
## Transfer Testnet SCOL from BC to TC

* Switch to ScolCoin Chain testnet after unlock your extension wallet and copy your address, start with `0x`
...
## Swap Testnet BEP2 token to its SRC20 equivalent

* Follow the instructions above to Install ScolCoin Chain extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to ScolCoin Chain testnet after unlock your extension wallet and Click at “+” to add your BEP2 token if necessary
...
**Verify your balance has enough SCOL to pay transfer fee**

* Switch to ScolCoin Chain testnet and copy your address, start with `0x`

<img src="https://lh3.googleusercontent.com/kidAixmzNbNt_ujj0BQqZdZ4ZBXdEkxJLSVIOsWnWxZGOeXUJBjhxYsLlxH6VSQWxNX-dzqBFhqXSW3zmshkL99QYcVxIFGxw6tF7xF9ffXZPMPKnXlt0sWCKvPV6RMJWHSx1H0O" alt="img" style="zoom:33%;" />

Click at “+” to add your SRC20 token if necessary
...
* Switch to ScolCoin Chain testnet, you should see your SRC20 token balance change
...
## Swap Testnet SRC20 token to its BEP2 equivalent

* Follow the instructions above to Install ScolCoin Chain extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to ScolCoin Chain testnet and Click at “+” to add your SRC20 token if necessary

<img src="https://lh5.googleusercontent.com/fW06aH1A5_7P93r8zSp4kgs5Us1AqYHvnfs6sRxg6aCLsQ7u9Ht_z6zLSExGjbr6J-D0vOmDWXghw544WhaNnkTP-nDAO3TFou5g_WYVvp7nOSrNX7w15PmvmZLyHkhBzLW_i-xi" alt="img" style="zoom:33%;" />

**Verify your balance has enough SCOL to pay transfer fee**

* Switch to ScolCoin Chain testnet and copy your address, start with `tscol1`

Note: for mainnet, the address starts with `scol1`
