...
SCOL and coins on ScolCoin Chain are supported by the Trezor hardware wallet. The following describes how to use Trezor to connect to TC.
...
ScolCoin Chain is compatible with MetaMask. Users can use MetaMask as a bridge between Trezor and ScolCoin Chain to make transactions to the ScolCoin Chain testnet.
