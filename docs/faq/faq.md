...
There is no need to register. All you need is a ScolCoin Chain address, which can be generated with
...
## What is the current Fee Table on ScolCoin Chain Mainnet?
