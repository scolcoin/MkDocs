...
SCOL DEX is the native marketplace on ScolCoin Chain, allowing you to exchange digital assets issued and listed on it.
...
SCOL DEX only accept LIMIT orders, which is adhering to SEC definitions of LIMIT orders
