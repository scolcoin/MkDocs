#  SCOL DEX Trading Interface


SCOL DEX trading page is designed to provide a user-friendly trading interface to everyone. To get started, go to the trading page first at https://www.scolcoin.com/trade. The trading page is composed of the following part:
...
- Balances: This section displays the current balance of your ScolCoin Chain Wallet.

### Order Form
SCOL DEX currently only supports Limit orders. The Limit order section allows you to define the bid/ask price and the quantity you wish to trade. Please note that all order’s parameters’ constrains:
