# ScolCoin Chain Transaction Encoding Specification

ScolCoin Chain transactions are protocol-based data types and can only be submitted in a compatible encoded frame.
